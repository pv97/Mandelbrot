...
/***/ function(module, exports, __webpack_require__) {
	...
	const JGraph = __webpack_require__(4);
	const Rectangle = __webpack_require__(5);
	...
	function MandelbrotJulia(){
	  ...
	  Jmask.addEventListener("mousemove",(e)=>{
	    if(drag){
	      ...
	      Jrectangle.render(vertex1,vertex2,Jratio,keepRatio);
	    }
	  })
	  ...
	  render(xrange,yrange,c,maxIter,color,precision){
	    ...
	    for (var y=0; y<this.height; y++) {
	      ...
	      for (var x=0; x<this.width; x+=p) {
	        ...
	        for (var z = 0; z < p; z++) {
	          // if (pixelindex%(4*this.width*y)+4<this.width){
